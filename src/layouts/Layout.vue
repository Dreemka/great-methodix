...
<template>
  <a-layout class="app-layout">
    ...
    >
      <div class="logo" :class="{ 'logo--collapsed': isSiderCollapsed }">
        <img
          v-if="isSiderCollapsed"
          class="logo-image"
          src="../assets/logo_minimize.svg"
          alt="App minimized logo"
        />
        <img
          v-else
          class="logo-image"
...
.app-sider:not(.ant-layout-sider-collapsed) :deep(.ant-menu-item) {
  padding-left: 15px;
  padding-right: 15px;
}
.logo {
