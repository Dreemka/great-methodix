...
- Страница с примером `jordium-gantt-vue3`, демонстрирующая задачи, зависимости и вехи.
...
> Для корректной работы Gantt необходимо, чтобы глобальные стили `jordium-gantt-vue3/dist/assets/jordium-gantt-vue3.css` были подключены (уже импортированы в `src/main.ts`).
